...
const char * const BITCOIN_CONF_FILENAME = "grosh.conf";
const char * const BITCOIN_PID_FILENAME = "grosh.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Grosh";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Grosh";
#else
    // Unix
    return pathRet / ".grosh";
#endif
#endif
}
