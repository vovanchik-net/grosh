...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vovanchik-net/grosh>";
    const std::string URL_WEBSITE = "<https://t.me/grosh_vovanchik_net>";
