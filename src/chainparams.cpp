...
// Copyright (c) 2021 Uladzimir(https://t.me/vovanchik_net)
...
static SeedSpec6 pnSeed6_mmain[] = {
    {{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0xff, 185, 231,  70,  34}, 12358},
    {{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0xff,  86,  57, 195, 202}, 12358},
};
...
public:
    CMainParams() {
        ...
        consensus.nPosTargetTimespan = 1 * 60 * 60;                 // 1 hour
        ...
        consensus.TLRHeight = 269371;
        consensus.nNewDiffAdjustmentAlgorithmHeight = 269371;
        consensus.nPowAveragingWindowv2 = 120;
        
        consensus.newProofHeight = 269371;

        // The best chain should have at least this much work.
        consensus.nMinimumChainWork =
            uint256S("0x0000000000000000000000000000000000000000000000000089d259b49d26f8"); // 200000 

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid =
            uint256S("0x60c8a6af7ea6cb07818b0a15acb058e4a3ec9f213eee3f2f311483ad0eb1dc31"); // 200000
        ...
        pchNetworkMessageStart[0] = 0x6b;
        pchNetworkMessageStart[1] = 0x53;
        pchNetworkMessageStart[2] = 0x41;
        pchNetworkMessageStart[3] = 0x6d;
        nDefaultPort = 12358;
        ...
        vFixedSeeds.clear();
        vFixedSeeds = std::vector<SeedSpec6>(pnSeed6_mmain, pnSeed6_mmain + ARRAYLEN(pnSeed6_mmain));
        ...
        checkpointData = {
            {
                ...
                {200000, uint256S("0x60c8a6af7ea6cb07818b0a15acb058e4a3ec9f213eee3f2f311483ad0eb1dc31")},
            }
        };
